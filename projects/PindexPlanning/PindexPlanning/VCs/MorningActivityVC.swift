...
class MorningActivityVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    @IBAction func btnLetsGo(_ sender: Any) {
        ...
        let choosedMorningCategory = jsonData["categories"][oPckView.selectedRow(inComponent: 0)]["id"].stringValue
        UserDefaults.standard.set(choosedMorningCategory, forKey: "morningActivity")
    }
