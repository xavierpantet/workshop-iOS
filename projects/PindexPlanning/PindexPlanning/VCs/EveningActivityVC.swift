...
class EveningActivityVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource  {
    ...
    @IBAction func btnLetsGo(_ sender: Any) {
        ...
        let choosedEveningCategory = jsonData["categories"][oPckView.selectedRow(inComponent: 0)]["id"].stringValue
        UserDefaults.standard.set(choosedEveningCategory, forKey: "eveningActivity")
    }
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return jsonData["categories"].count
    }
    
    // Texte à afficher pour le row-ième élément du PickerView
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return jsonData["categories"][row]["name"].stringValue
    }
}
